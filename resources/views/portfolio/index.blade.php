        ...
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="cs_hero_info cs_pr_20">
              ...
              <h1 class="cs_hero_title cs_font_92 cs_black wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s"><span class="cs_gradient_text">Piyush </span><span
                  class="cs_gradient_border_text">kumawat</span></h1>
              <h4 class="cs_hero_subtitle cs_font_36 cs_semi_bold cs_primary_font cs_white_blue_text_2">Full-stack
              ...
              <p class="cs_about_text">
                ...
                <span class="cs_primary_color">Laravel Framework</span> and <span class="cs_primary_color">MVC architecture</span>, 
                focusing primarily on <span class="cs_primary_color">Backend Development</span>.  
                I have strong experience working with <span class="cs_primary_color">MySQL Database</span> and can efficiently integrate 
              ...
              <div class="cs_btns">
                <a href="assets/cv/Piyush-Kumawat-.pdf"class="cs_btn cs_style_1" download><span>Download CV</span></a>
          ...
          <div class="col-lg-6">
            ...
            <div class="cs_imagebox_img w-100"><img src="assets/img/hero/hero_1.png" alt="heroImg"></div>
              <div
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="cs_pr_50">
              ...
              <ul class="m-0">
                <li>✅ <strong>Expert in Laravel & PHP:</strong> Strong backend skills in <span class="cs_primary_color">Laravel, Core PHP, and MySQL</span>.</li>
                <li>✅ <strong>Full-Stack Capabilities:</strong> Proficient in <span class="cs_primary_color">HTML, CSS, JavaScript, and Bootstrap</span>.</li>
                <li>✅ <strong>Real-World Experience:</strong> Worked on <span class="cs_primary_color">E-commerce, Coin Systems, and Custom Web Apps</span>.</li>
                <li>✅ <strong>SEO & Performance Optimization:</strong> Expertise in <span class="cs_primary_color">On-page & Technical SEO</span>.</li>
                <li>✅ <strong>Secure & Scalable Development:</strong> Focus on <span class="cs_primary_color">API security, database optimization, and scalability</span>.</li>
                <li>✅ <strong>Version Control & Teamwork:</strong> Proficient in <span class="cs_primary_color">Git & GitHub</span> for smooth collaboration.</li>
              </ul>
              ...
              <div class="cs_iconbox cs_style_2 cs_radius_20 cs_transition_4">
                <div class="cs_iconbox_in">
                  ...
                  <div class="cs_iconbox_info position-relative w-100">
                    ...
                    <p class="cs_iconbox_text">Expertise in HTML, CSS, JavaScript, Bootstrap, and jQuery.</p>
                    <div class="d-flex justify-content-between align-items-center">
                      <span
                        class="cs_letter_spacing_15 cs_ternary_color cs_secondary_font cs_font_15 text-uppercase m-0">50+ Projects</span>
                      <a href="portfolio" class="cs_circle_btn cs_style_1 cs_accent_color_2 cs_center rounded-circle">
              ...
              <div class="cs_iconbox cs_style_2 cs_radius_20 cs_transition_4">
                <div class="cs_iconbox_in">
                  ...
                  <div class="cs_iconbox_info position-relative w-100">
                    ...
                    <p class="cs_iconbox_text">Specialized in Laravel, Core PHP, MySQL, and API integrations.</p>
                    <div class="d-flex justify-content-between align-items-center">
                      <span
              ...
              <div class="cs_iconbox cs_style_2 cs_radius_20 cs_transition_4">
                <div class="cs_iconbox_in">
                  ...
                  <div class="cs_iconbox_info position-relative w-100">
                    ...
                    <p class="cs_iconbox_text">Skilled in On-page, Off-page, and Technical SEO strategies.</p>
                    <div class="d-flex justify-content-between align-items-center">
                      <span
            ...
            <div class="cs_testimonial cs_style_2 cs_radius_20 cs_white_bg cs_transition_3 cs_transform_up_hover_3">
              <div class="cs_testimonial_in">
                ...
                <div class="cs_testimonial_info">
                  <img class="cs_testimonial_quote" src="assets/img/icon/Quote.svg" alt="Testimonial Quote">
                  <p class="cs_testimonial_text">
                    "He developed a custom Telegram bot for our coin distribution system. The API integrations and 
            ...
            <div class="cs_testimonial cs_style_2 cs_radius_20 cs_white_bg cs_transition_3 cs_transform_up_hover_3">
              <div class="cs_testimonial_in">
                ...
                <div class="cs_testimonial_info">
                  ...
                  <p class="cs_testimonial_text">
                    "Piyush built a high-performing Laravel-based e-commerce website for us. The SEO optimization 
      ...
      <div class="container">
        ...
        <div class="cs_blog_group_1">
          <div class="cs_blog cs_style_3 cs_transition_3 cs_white_bg cs_radius_20 cs_transform_up_hover_3">
            <div class="cs_blog_in">
              ...
              <div class="cs_blog_info">
                <h3 class="cs_blog_title cs_font_28"><a class="cs_accent_color_2_hover" href="blog-details"> Mastering Laravel: Best Practices for Scalable Web Applications</a></h3>
                <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="cs_blog cs_style_2 cs_transition_4">
            ...
            <div class="cs_blog_info">
              <h2 class="cs_blog_title cs_font_20 cs_semi_bold"><a class="cs_accent_color_2_hover" href="blog-details">Optimizing MySQL Queries for High-Performance Applications</a></h2>
              <div class="cs_blog_avater d-flex align-items-center">
                <img src="assets/img/blog/a3.png" alt="avatar_img">
                <div class="cs_ml_20">
                  <h2 class="cs_blog_name cs_font_20 cs_semi_bold mb-0">Piyush Kumawat</h2>
          ...
          <div class="cs_blog cs_style_2 cs_transition_4">
            ...
            <div class="cs_blog_info">
              <h2 class="cs_blog_title cs_font_20 cs_semi_bold"><a class="cs_accent_color_2_hover" href="blog-details">SEO for Developers: How to Rank Your Web Projects</a></h2>
              <div class="cs_blog_avater d-flex align-items-center">
          ...
          <div class="cs_blog cs_style_2 cs_transition_4">
            ...
            <div class="cs_blog_info">
              <h2 class="cs_blog_title cs_font_20 cs_semi_bold"><a class="cs_accent_color_2_hover" href="blog-details">Building a Secure Authentication System in Laravel</a></h2>
              <div class="cs_blog_avater d-flex align-items-center">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="cs_section_heading cs_style_1">
              ...
              <p class="mb-0">
                With hands-on experience in **Laravel, PHP, and MySQL**, I have successfully built and optimized **e-commerce platforms, 
                coin distribution systems, and custom web applications** for businesses across different industries.  
                My focus is on **performance, security, and scalability**, ensuring seamless digital solutions for my clients.
              </p>
