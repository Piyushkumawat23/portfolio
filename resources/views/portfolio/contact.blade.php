...
@section('content')
    ...
    <main>
        <!-- Start Hero Section -->
        <section class="cs_hero cs_style_3 cs_type_1 cs_filled_bg cs_center text-center" data-src="assets/img/bg/hero_bg_5.svg">
            <div class="container">
                    ...
                    <path fill-rule="evenodd" clip-rule="evenodd"
                      ...
                      fill="#342EAD" />
                                ...
                                <div class="cs_iconbox_info">
                                    ...
                                    <p class="cs_iconbox_text">Read my latest blogs on Laravel, PHP, and Web Development.</p>
                    ...
                    <path fill-rule="evenodd" clip-rule="evenodd"
                      ...
                      fill="#342EAD" />
                                ...
                                <div class="cs_iconbox_info">
                                    ...
                                    <p class="cs_iconbox_text">Have questions about my services? Find all the answers here.</p>
                                    <a class="cs_accent_color_2 cs_accent_color_hover cs_text_btn" href="faq">Check FAQ’s</a>
                                  </div>
