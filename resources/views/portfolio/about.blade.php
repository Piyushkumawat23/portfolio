                        ...
                        <div class="cs_education_wrap">
                            ...
                            <div class="cs_iconbox cs_style_3 d-flex align-items-center">
                                ...
                                <div class="cs_iconbox_info">
                                    ...
                                    <h3 class="cs_iconbox_title cs_font_24 cs_semi_bold mb-0">Bachelor of Computer
                                        Applications (2021 - 2024)</h3>
                                </div>
                            </div>
                            <div class="cs_iconbox cs_style_3 d-flex align-items-center">
                                <div class="cs_iconbox_icon cs_accent_color_2 cs_filled_bg cs_center"
                                ...
                                <div class="cs_iconbox_info">
                                    ...
                                    <h3 class="cs_iconbox_title cs_font_24 cs_semi_bold mb-0">Class 12th, Rajasthan Board
                                        (2020 - 2021)</h3>
                                </div>
                            </div>
                            {{-- <div class="cs_iconbox cs_style_3 d-flex align-items-center">
