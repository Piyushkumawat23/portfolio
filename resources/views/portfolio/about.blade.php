          ...
          <div class="col-lg-6">
            <div class="cs_about cs_style_1 cs_pl_50">
              ...
              <p class="cs_about_text">
                Hi, I’m **Piyush Kumawat**, a passionate **PHP & Laravel Developer** based in **Jaipur, India**.  
                I specialize in **backend development**, creating scalable and secure web applications using **Laravel, Core PHP, and MySQL**.  
                My focus is on **delivering high-performance solutions** that help businesses grow.  
              </p>
              
              <p class="cs_about_text">
                With experience in **API integrations, database optimization, and security enhancements**, I ensure that every  
                project I work on is **efficient, fast, and reliable**. I have built **e-commerce platforms, coin distribution  
                systems, and custom web applications**, always keeping user experience and functionality in mind.  
              </p>
              
              <p class="cs_about_text">
                Apart from backend development, I have hands-on experience in **frontend technologies** like  
                **HTML, CSS, JavaScript, Bootstrap, and jQuery**. I also understand the importance of **SEO**  
              ...
              <ul class="cs_mp_0 cs_about_summary_list">
                ...
                <li>
                  ...
                  <h5 class="cs_font_20 m-0 cs_semi_bold">
                    PHP, Laravel, MySQL, API Development, Core PHP, HTML, CSS, JavaScript, Bootstrap, Git, SEO
                  </h5>
                </li>
                <li>
                ...
                <li>
                  ...
                  <h5 class="cs_font_20 m-0 cs_semi_bold wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">
        ...
        <div class="row">
            ...
            <div class="cs_education_wrap">
              ...
              <div class="cs_iconbox cs_style_3 d-flex align-items-center">
                ...
                <div class="cs_iconbox_info">
                  <p class="cs_iconbox_text mb-0">Sri Balaji PG Mahavidyalaya, Rajasthan University</p>
                  <h3 class="cs_iconbox_title cs_font_24 cs_semi_bold mb-0">Bachelor of Computer Applications (2021 - 2024)</h3>
                </div>
              </div>
              <div class="cs_iconbox cs_style_3 d-flex align-items-center">
                <div class="cs_iconbox_icon cs_accent_color_2 cs_filled_bg cs_center"
                ...
                <div class="cs_iconbox_info">
                  <p class="cs_iconbox_text mb-0">Aanand Public Sr. Sec. School</p>
                  <h3 class="cs_iconbox_title cs_font_24 cs_semi_bold mb-0">Class 12th, Rajasthan Board (2020 - 2021)</h3>
                </div>
              </div>
              {{-- <div class="cs_iconbox cs_style_3 d-flex align-items-center">
                <div class="cs_iconbox_icon cs_accent_color_2 cs_filled_bg cs_center"
          ...
          <div class="col-lg-6">
            <div class="cs_slill_wrap cs_pl_70">
              ...
              <div class="cs_progressbar cs_style_2">
                <div class="label cs_font_20 cs_semi_bold">Frontend Development (HTML, CSS, JavaScript, Bootstrap)</div>
        ...
        <div class="cs_brands cs_style_1 cs_type_1">
          <div class="cs_brand overflow-hidden cs_radius_10 text-center">
            <div class="cs_brand_logo_wrap cs_center cs_brand_bg_1">
              {{-- <img class="cs_brand_logo" src="assets/img/client/bautlr.svg" alt="Bautlr"> --}}
          ...
          <div class="cs_brand overflow-hidden cs_radius_10 text-center">
            <div class="cs_brand_logo_wrap cs_center cs_brand_bg_2">
              {{-- <img class="cs_brand_logo" src="assets/img/client/pandb.svg" alt="PandB Imports"> --}}
          ...
          <div class="cs_brand overflow-hidden cs_radius_10 text-center">
            <div class="cs_brand_logo_wrap cs_center cs_brand_bg_3">
                ...
                {{-- <img class="cs_brand_logo" src="assets/img/client/unitrade.svg" alt="Unitrade Coin System"> --}}
            </div>
          ...
          <div class="cs_brand overflow-hidden cs_radius_10 text-center">
            <div class="cs_brand_logo_wrap cs_center cs_brand_bg_4">
                ...
                {{-- <img class="cs_brand_logo" src="assets/img/client/vostro.svg" alt="Vostro Market"> --}}
            </div>
