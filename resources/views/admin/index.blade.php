                    ...
                    <div class="direct-chat-messages">
                      ...
                      <div class="direct-chat-msg">
                        ...
                        <img
                          ...
                          src="{{ asset('public/assets/admin/assets/img/user1-128x128.jpg')}}"
                      ...
                      <div class="direct-chat-msg end">
                        ...
                        <img
                          class="direct-chat-img"
                          src="{{ asset('public/assets/admin/assets/img/user3-128x128.jpg')}}"
                          alt="message user image"
                        />
                        <!-- /.direct-chat-img -->
                      ...
                      <ul class="contacts-list">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="{{ asset('public/assets/admin/assets/img/user7-128x128.jpg')}}"
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="{{ asset('public/assets/admin/assets/img/user5-128x128.jpg')}}"
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="{{ asset('public/assets/admin/assets/img/user6-128x128.jpg')}}"
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="{{ asset('public/assets/admin/assets/img/user8-128x128.jpg')}}"
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
